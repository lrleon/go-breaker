...
def set_delay(delay) set('set_delay', delay) end

def request; consult('test') end
...
def percentile; consult('percentile') end

def wait_time; consult('wait') end
...
def set_percentile(percentile) set('set_percentile', percentile) end

def set_wait_time(wait_time) set('set_wait', wait_time) end
