...
% Logo setup
\titlegraphic{\includegraphics[width=3cm]{genius_sports_logo.png}}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \begin{tikzpicture}[scale=0.8]
                    ...
                    \node at (1,0.5) {\small Service A};
                    
                    \draw[thick] (3,0) rectangle (5,1);
                    \node at (4,0.5) {\small Service B};
                    
                    \draw[thick,->] (2.1,0.5) -- (2.9,0.5);
                    \node[above] at (2.5,0.5) {\tiny API};
        ...
        \begin{column}{0.4\textwidth}
            \begin{center}
                ...
                \begin{tikzpicture}[scale=0.7]
                    ...
                    \node at (0.5,4.25) {\tiny Users};
                    
                    % Frontend
                    \draw[thick,red] (0,3) rectangle (1,3.5);
                    \node at (0.5,3.25) {\tiny Frontend};
                    
                    % API Gateway
                    \draw[thick,red] (0,2) rectangle (1,2.5);
                    \node at (0.5,2.25) {\tiny API GW};
                    ...
                    % Database (failed)
                    \draw[thick,red,fill=red!20] (0,0) rectangle (1,0.5);
                    \node at (0.5,0.25) {\tiny Database};
                    
                    % Arrows showing failure propagation
                    \draw[thick,red,->] (0.5,0.5) -- (0.5,1);
                    \draw[thick,red,->] (0.5,1.5) -- (0.5,2);
                    \draw[thick,red,->] (0.5,2.5) -- (0.5,3);
                    \draw[thick,red,->] (0.5,3.5) -- (0.5,4);
                \end{tikzpicture}
            \end{center}
        \end{column}
    \end{columns}
...
\begin{frame}{Integration Example: Sports Data API}
    \begin{center}
        \textbf{Basketball API Architecture}
        \begin{tikzpicture}[scale=0.9]
            % Client
            \draw[thick,fill=blue!20] (0,3) rectangle (1.5,4);
            \node at (0.75,3.5) {\tiny Mobile App};
            
            % API Gateway
            \draw[thick,fill=green!20] (2,3) rectangle (3.5,4);
            \node at (2.75,3.5) {\tiny API Gateway};
            
            % Basketball Service
            \draw[thick,fill=geniusblue!20] (4,3) rectangle (6,4);
            \node at (5,3.5) {\textbf{Basketball API}};
            
            % Circuit Breakers
            \draw[thick,fill=yellow!30] (6.5,4) rectangle (7.5,4.5);
            \node at (7,4.25) {\tiny CB};
            
            \draw[thick,fill=yellow!30] (6.5,3.3) rectangle (7.5,3.8);
            \node at (7,3.55) {\tiny CB};
            
            \draw[thick,fill=yellow!30] (6.5,2.6) rectangle (7.5,3.1);
            \node at (7,2.85) {\tiny CB};
            
            % Dependencies
            \draw[thick,fill=orange!20] (8,4) rectangle (9.5,4.5);
            \node at (8.75,4.25) {\tiny Database};
            
            \draw[thick,fill=orange!20] (8,3.3) rectangle (9.5,3.8);
            \node at (8.75,3.55) {\tiny Stats API};
            
            \draw[thick,fill=orange!20] (8,2.6) rectangle (9.5,3.1);
            \node at (8.75,2.85) {\tiny Auth Service};
            
            % Connections
            \draw[thick,->] (1.5,3.5) -- (2,3.5);
            \draw[thick,->] (3.5,3.5) -- (4,3.5);
            \draw[thick,->] (6,4.2) -- (6.5,4.2);
            \draw[thick,->] (6,3.55) -- (6.5,3.55);
            \draw[thick,->] (6,2.85) -- (6.5,2.85);
            \draw[thick,->] (7.5,4.25) -- (8,4.25);
            \draw[thick,->] (7.5,3.55) -- (8,3.55);
            \draw[thick,->] (7.5,2.85) -- (8,2.85);
            
            % Status indicators (only 2 states)
            \node at (7,2.2) {\circuitclosed};
            \node at (7,1.8) {\circuitopen};
        \end{tikzpicture}
    \end{center}
...
\begin{frame}{Key Metrics and KPIs}
    \begin{center}
        \begin{tikzpicture}[scale=0.8]
            % Availability improvement
            \draw[thick,fill=blue!20] (0,3) rectangle (2,4);
            \node at (1,3.7) {\textbf{99.9\%}};
            \node at (1,3.3) {\tiny Availability};
            
            % MTTR reduction
            \draw[thick,fill=green!20] (2.5,3) rectangle (4.5,4);
            \node at (3.5,3.7) {\textbf{< 60s}};
            \node at (3.5,3.3) {\tiny MTTR};
            
            % False positives
            \draw[thick,fill=yellow!20] (5,3) rectangle (7,4);
            \node at (6,3.7) {\textbf{< 2\%}};
            \node at (6,3.3) {\tiny False Positives};
            
            % Alert reduction
            \draw[thick,fill=orange!20] (0,1.5) rectangle (2,2.5);
            \node at (1,2.2) {\textbf{-75\%}};
            \node at (1,1.8) {\tiny Alert Noise};
            
            % Performance impact
            \draw[thick,fill=purple!20] (2.5,1.5) rectangle (4.5,2.5);
            \node at (3.5,2.2) {\textbf{< 1ms}};
            \node at (3.5,1.8) {\tiny Overhead};
            
            % Team satisfaction
            \draw[thick,fill=red!20] (5,1.5) rectangle (7,2.5);
            \node at (6,2.2) {\textbf{+40\%}};
            \node at (6,1.8) {\tiny Team Confidence};
        \end{tikzpicture}
    \end{center}
    
    \textbf{Production Statistics (Last 6 months):}
    \begin{multicols}{2}
        \begin{itemize}
            \item 247 circuit breaker activations
            \item 89\% automatic recovery
            \item 0 cascade failures
            \item 12 prevented outages
            \item 2.3s average recovery time
            \item 99.97\% uptime achieved
        \end{itemize}
    \end{multicols}
\end{frame}
...
\begin{frame}{Questions \& Discussion}
    \begin{center}
        ...
        \begin{tikzpicture}
            \node at (0,0) {\includegraphics[width=4cm]{genius_sports_logo.png}};
        \end{tikzpicture}
